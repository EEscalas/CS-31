...
int main()
{
	...
	cout << "How many diesel Volkswagen owners were surveyes?";
	cin >> numberSurveyed;
	cout << "How many of them say they will take a payment and keep their car?";
	cin >> numKeep;
	cout <<  "How many of them say they will return tgeir car for a refund?";
	cin >> numRefund;
...
//	cout << pctRefund << "% say they will demand refund." << endl;
//
