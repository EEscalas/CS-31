...
void Player::moveOrAttack(int dir)
{
	...
	if (m_arena->determineNewPosition(m_row, m_col, dir))
	{
		if (m_arena->nRobotsAt(m_row, m_col) > 0)
		{
			m_arena->attackRobotAt(m_row, m_col, dir);
			switch (dir)								// undo the move that determineNewPosition set, because you attacked instead of moved
			{
				case UP: m_row++; break;
...
void Arena::display() const
{
	...
	for (int k = 0; k < m_nRobots; k++)
	{
		...
		switch (nRobotsAt(m_robots[k]->row(), m_robots[k]->col()))
		{
			case 1:
				grid[(m_robots[k]->row())-1][(m_robots[k]->col())-1] = 'R';
				break;
			case 2:
				grid[(m_robots[k]->row())-1][(m_robots[k]->col())-1] = '2';
				break;
			case 3:
				grid[(m_robots[k]->row())-1][(m_robots[k]->col())-1] = '3';
				break;
			case 4:
				grid[(m_robots[k]->row())-1][(m_robots[k]->col())-1] = '4';
				break;
			case 5:
				grid[(m_robots[k]->row())-1][(m_robots[k]->col())-1] = '5';
				break;
			case 6:
				grid[(m_robots[k]->row())-1][(m_robots[k]->col())-1] = '6';
				break;
			case 7:
				grid[(m_robots[k]->row())-1][(m_robots[k]->col())-1] = '7';
				break;
			case 8:
				grid[(m_robots[k]->row())-1][(m_robots[k]->col())-1] = '8';
				break;
			default:
				grid[(m_robots[k]->row())-1][(m_robots[k]->col())-1] = '9';
				break;
		}
	}
